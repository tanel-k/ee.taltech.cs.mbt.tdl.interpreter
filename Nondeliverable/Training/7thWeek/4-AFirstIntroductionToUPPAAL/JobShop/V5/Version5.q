...
*/
E<> now < 127 && (Belt.i == JOBS && Jobber(0).begin && Jobber(1).begin)\
...
*/
A[] now >= 127 imply (Belt.i == JOBS && Jobber(0).begin && Jobber(1).begin)\


/*

*/
A[] now >= 110 imply (Belt.i == JOBS && Jobber(0).begin && Jobber(1).begin)\


/*

*/
A[] now >= 150 imply (Belt.i == JOBS && Jobber(0).begin && Jobber(1).begin)\


/*

*/
A[] now >= 200 imply (Belt.i == JOBS && Jobber(0).begin && Jobber(1).begin)\


/*

*/
E<> (Belt.i == JOBS && Jobber(0).begin && Jobber(1).begin)\
...
*/
A[] Hammer.taken == (Jobber(0).work_avg_hammer || Jobber(0).work_hard || Jobber(1).work_avg_hammer || Jobber(1).work_hard)

/*

*/
A[] Mallet.taken == (Jobber(0).work_avg_mallet || Jobber(1).work_avg_mallet)
