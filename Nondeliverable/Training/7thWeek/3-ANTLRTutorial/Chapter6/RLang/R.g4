...
/*
Notice that NL doesn't say to discard those tokens as is customery.
The parser uses them as expression terminators, like semicolons in Java,
so the lexer must pass them to the parser.
*/
