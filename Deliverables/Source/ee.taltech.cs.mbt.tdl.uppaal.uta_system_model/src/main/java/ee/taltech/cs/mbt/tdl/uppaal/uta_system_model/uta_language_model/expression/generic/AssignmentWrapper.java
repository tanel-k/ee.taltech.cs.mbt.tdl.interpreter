package ee.taltech.cs.mbt.tdl.uppaal.uta_system_model.uta_language_model.expression.generic;

import ee.taltech.cs.mbt.tdl.uppaal.uta_system_model.uta_language_model.expression.generic.internal.AbsInternalExpression;
	...
	> extends AbsInternalExpression
{
	...
	public AssignmentWrapper(WrappedType operatorExpression) {
