...
import ee.taltech.cs.mbt.tdl.uppaal.tdl_parser.xml.jaxb.XmlNodeNta;
...
public class NtaMarshaller {
	private static final String SAX_FEATURE_DISABLE_EXTERNAL_DTD_LOADING = "http://apache.org/xml/features/nonvalidating/load-external-dtd";
	...
	private static SAXSource getSaxSource(InputStream in) throws SAXException, ParserConfigurationException {
		...
		parserFactory.setFeature(SAX_FEATURE_DISABLE_EXTERNAL_DTD_LOADING, false);
