...
public class TransitionLabelNode {

    @XmlValue
    protected String value;
    @XmlAttribute(name = "kind")
    protected EAttrTransitionLabelKindAttr kind;
    @XmlAttribute(name = "x")
    protected Integer x;
    @XmlAttribute(name = "y")
    protected Integer y;
     ...
     * @return
     *     possible object is
     *     {@link EAttrTransitionLabelKindAttr }
     *     
     */
    public EAttrTransitionLabelKindAttr getKind() {
        return kind;
    }
     ...
     *     
     */
    public void setKind(EAttrTransitionLabelKindAttr value) {
        this.kind = value;
    }
