	...
	implements IParseTreeConverter<ExpressionTree, ExpressionContext>
{
	...
	@Override
	public ExpressionTree convert(ExpressionContext rootContext) throws ParseTreeStructureException {
	...
	private ExpressionTree getResult() throws ParseTreeStructureException {
		if (getRootNode() == null) {
