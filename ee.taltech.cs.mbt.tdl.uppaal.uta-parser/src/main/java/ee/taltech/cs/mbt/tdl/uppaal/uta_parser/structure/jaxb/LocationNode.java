...
public class LocationNode {
    ...
    protected List<LocationLabelNode> labels = new LinkedList<LocationLabelNode>();
    protected MarkerNode committed;
    protected MarkerNode urgent;
     ...
     * {@link LocationLabelNode }
     * 
     * 
     */
    public List<LocationLabelNode> getLabels() {
        if (labels == null) {
            labels = new LinkedList<LocationLabelNode>();
        }
        return this.labels;
    }
     ...
     *     
     */
    public MarkerNode getCommitted() {
        return committed;
    }
     ...
     *     
     */
    public void setCommitted(MarkerNode value) {
     ...
     *     
     */
    public void setUrgent(MarkerNode value) {
        this.urgent = value;
    }
